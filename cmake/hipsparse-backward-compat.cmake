...
set(PROJECT_FILE_REORG_INC_DIR    ${PROJECT_SOURCE_DIR}/library/include/hipsparse)
set(PROJECT_WRAPPER_TEMPLATE_FILE ${PROJECT_SOURCE_DIR}/header.hpp.in)
set(PROJECT_WRAPPER_INC_DIR       ${PROJECT_BINARY_DIR}/hipsparse/include)
...
set(PROJECT_WRAPPER_INC_RELATIVE_PATH     "${include_statements}#include \"../../include/hipsparse")
set(PROJECT_SLINK_INC_RELATIVE_PATH       "${include_statements}#include \"./hipsparse")


# Function for Generating Wrapper Headers for Backward Compatibilty
# Generates wrapper for all *.h files in include/hipsparse folder.
# No Arguments to function.
# Wrapper are generated under hipsparse/include and symlink under include/.
function (package_gen_bkwdcomp_hdrs)
	# Get list of *.h files in folder include/hipsparse 
...
# Wrapper generated for the input file under hipsparse/include and symlink under include/.
